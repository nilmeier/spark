...
#export MVN_BUILD_PARAMS="-Pyarn -Phadoop-2.3 -Dhadoop.version=2.3.0 -Pkinesis-asl -Phive -Phive-thriftserver"
...
export MVN_BUILD_PARAMS="-Pyarn -Phadoop-2.7 -Dhadoop.version=2.6.0 -Pkinesis-asl -Phive -Phive-thriftserver -Psparkr"
export MVN_TEST_PARAMS="-Pyarn -Phadoop-2.7 -Dhadoop.version=2.6.0 -Pkinesis-asl"
